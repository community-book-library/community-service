create table communitylibrary.community(community_id SMALLINT UNSIGNED not null AUTO_INCREMENT, community_name varchar(100) not null,
community_type ENUM('APARTMENTS','CONDOS','TOWNHOUSES','SINGLE_FAMILY') not null,
city CHAR(255) not null,state CHAR(2) not null, zip CHAR(5) not null, zip4 CHAR(4) not null,
